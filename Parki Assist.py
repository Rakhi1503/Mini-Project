...
def send():
    ...
    elif (user == "How can I take care of myself" or user == "how to manage the symptoms" or user == "now what"):
        txt.insert(END, "\n\n" + "Bot -> Parkinson’s disease isn’t a condition you can self-diagnose, and you shouldn’t try to \n manage the symptoms without first talking to a healthcare provider.")
    ...
    elif (user == "is there a platform to help me" or user == "where to seek help"):
...
txt.insert(END,"\n" + "Bot -> Hi there, Parki Assist at your service.Please do not fret and let me know how I can help" "\n")
